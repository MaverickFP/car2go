...
/**
 * Session Bean implementation class GeoEJB
 */
@Stateless(mappedName = "GeoEJB")
@Remote
public class GeoEJB implements GeoService {
	...
	@Override
	public float calcolaDistanza(double userLat, double userLng, double venueLat, double venueLng) {
