...
<div id="container">
  ...
  <div id="maincol">
	...
	<c:forEach var="prenotazione" items="${prenotazioni}">
		<li>
			<strong>Macchina</strong>: ${prenotazione.nomeMacchina}; <strong>Distanza</strong>: ${prenotazione.distanza} ; <strong>Tempo</strong> ${prenotazione.tempo}; <strong>Costo</strong> ${prenotazione.costo}; <strong>Data</strong> ${prenotazione.data}
		</li>	
	</c:forEach>
