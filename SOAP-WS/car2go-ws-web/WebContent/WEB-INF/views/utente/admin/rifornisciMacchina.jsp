...
<div id="container">
  ...
  <div id="maincol">
    ...
    <div class="rule">
      <h1>Rifornisci Auto</h1>
    </div>   
    
    <p><img src="<s:url value="/resources/images/oil-512.png"/>"  width="240" /></p>
    <p>Elenco delle macchine che necessitano di rifornimento.</p>


<ul>
		<c:forEach var="macchina" items="${macchine}">
		
			<li>Macchina:  ${macchina.tipo} / ${macchina.codice}  	
				
				<form action="doRifornimento" method="post">
					<input type="hidden" name="idMacchina" value="${macchina.idMacchina}"/>
					<input type="submit" value="Rifornisci"/>
				</form> 
