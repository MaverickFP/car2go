...
<div id="container">
  ...
  <div id="maincol">
    ...
    <div class="rule">
      <h1>Ripara Esterno Auto</h1>
    </div>   
    
    <p><img src="<s:url value="/resources/images/car2.jpg"/>"  width="240" /></p>
   <p>Seleziona l'auto che si desidera riparare.<p>

<ul>
		<c:forEach var="macchina" items="${macchine}">
		
			<li>Macchina:  ${macchina.tipo} / ${macchina.codice} / Guasto: ${macchina.guasto} 	
				
				<form action="doRiparaEsterno" method="post">
					<input type="hidden" name="idMacchina" value="${macchina.idMacchina}"/>
					<input type="submit" value="Ripara"/>
				</form> 
